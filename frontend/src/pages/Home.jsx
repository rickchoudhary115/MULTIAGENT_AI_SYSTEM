      ...
      {!userData && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="w-[340px] bg-black/80 p-7 rounded-2xl border border-white/[0.08]flex flex-col gap-5">
            ...
            <button
              className="bg-blue-500 hover:from-indigo-400 hover:to-violet-600 text-white font-bold py-[12px] px-4 flex items-center justify-center gap-3 w-full  rounded-xl text-white bg-gradient-to-r from-indigo-500 to-violet-600 active:to-violet-800 border border-indigo-500/30 shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40  transition-all duration-150 cursor-pointer"
              onClick={Googlelogin}
            >
              <FcGoogle size={15} />
              Login with Google
